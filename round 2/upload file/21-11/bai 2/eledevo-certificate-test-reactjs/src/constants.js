...
export const DELETE_ONEIMG_ITEM_REQUEST = 'DELETE_ONEIMG_ITEM_REQUEST'
export const DELETE_ONEIMG_ITEM_SUCCESS = 'DELETE_ONEIMG_ITEM_SUCCESS'
export const DELETE_ONEIMG_ITEM_FAILURE = 'DELETE_ONEIMG_ITEM_FAILURE'
// HTTP headers

...
export const PAGINATION_EXCEL_REQUEST = 'PAGINATION_EXCEL_REQUEST'
export const PAGINATION_EXCEL_SUCCESS = 'PAGINATION_EXCEL_SUCCESS'
export const PAGINATION_EXCEL_FAILURE = 'PAGINATION_EXCEL_FAILURE'
